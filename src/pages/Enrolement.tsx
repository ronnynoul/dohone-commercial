        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              {...register("name")}
               className="w-full px-4 py-2 border border-gray-500 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400"
          ...
          <div>
            ...
            <input
              type="tel"
              {...register("phone")}
               className="w-full px-4 py-2 border border-gray-500 rounded-lg bg-white text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400"
